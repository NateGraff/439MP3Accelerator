...
src/libmad/%.o: ../src/libmad/%.c
	...
	arm-none-eabi-gcc -Wall -O0 -g3 -I../../standalone_bsp_2/ps7_cortexa9_0/include -I"C:\Xilinx\projects\CPE439\MP3Project\MP3Accelerator\MP3Accelerator.sdk\MP3Accelerator\src\SD" -c -fmessage-length=0 -MT"$@" -mcpu=cortex-a9 -mfpu=vfpv3 -mfloat-abi=hard -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -o "$@" "$<"
