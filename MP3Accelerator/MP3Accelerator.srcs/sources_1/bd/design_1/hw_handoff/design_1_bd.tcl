...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set ap_clk [ create_bd_port -dir O -type clk ap_clk ]
  set ap_fifo_iarg_0_dout [ create_bd_port -dir O -from 31 -to 0 ap_fifo_iarg_0_dout ]
  set ap_fifo_iarg_0_empty_n [ create_bd_port -dir O ap_fifo_iarg_0_empty_n ]
  set ap_fifo_iarg_0_read [ create_bd_port -dir I ap_fifo_iarg_0_read ]
  set ap_fifo_oarg_0_din [ create_bd_port -dir I -from 31 -to 0 ap_fifo_oarg_0_din ]
  set ap_fifo_oarg_0_full_n [ create_bd_port -dir O ap_fifo_oarg_0_full_n ]
  set ap_fifo_oarg_0_write [ create_bd_port -dir I ap_fifo_oarg_0_write ]
  set ap_rst [ create_bd_port -dir O -type rst ap_rst ]
...
CONFIG.C_IARG_HAS_BRAM {0} \
CONFIG.C_IARG_HAS_FIFO {1} \
CONFIG.C_N_INPUT_ARGS {1} \
CONFIG.C_N_INPUT_SCALARS {0} \
...
CONFIG.PCW_IMPORT_BOARD_PRESET {C:/Users/nate/Downloads/ZYBO_zynq_def.xml} \
...
CONFIG.NUM_MI {2} \
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins axis_accelerator_adapter_0/S_AXIS_0]
  ...
  connect_bd_intf_net -intf_net axis_accelerator_adapter_0_M_AXIS_0 [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins axis_accelerator_adapter_0/M_AXIS_0]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M01_AXI [get_bd_intf_pins axis_accelerator_adapter_0/S_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M01_AXI]

  # Create port connections
  connect_bd_net -net ap_fifo_iarg_0_read_1 [get_bd_ports ap_fifo_iarg_0_read] [get_bd_pins axis_accelerator_adapter_0/ap_fifo_iarg_0_read]
  connect_bd_net -net ap_fifo_oarg_0_din_1 [get_bd_ports ap_fifo_oarg_0_din] [get_bd_pins axis_accelerator_adapter_0/ap_fifo_oarg_0_din]
  connect_bd_net -net ap_fifo_oarg_0_write_1 [get_bd_ports ap_fifo_oarg_0_write] [get_bd_pins axis_accelerator_adapter_0/ap_fifo_oarg_0_write]
  connect_bd_net -net axis_accelerator_adapter_0_ap_fifo_iarg_0_dout [get_bd_ports ap_fifo_iarg_0_dout] [get_bd_pins axis_accelerator_adapter_0/ap_fifo_iarg_0_dout]
  connect_bd_net -net axis_accelerator_adapter_0_ap_fifo_iarg_0_empty_n [get_bd_ports ap_fifo_iarg_0_empty_n] [get_bd_pins axis_accelerator_adapter_0/ap_fifo_iarg_0_empty_n]
  connect_bd_net -net axis_accelerator_adapter_0_ap_fifo_oarg_0_full_n [get_bd_ports ap_fifo_oarg_0_full_n] [get_bd_pins axis_accelerator_adapter_0/ap_fifo_oarg_0_full_n]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_ports ap_clk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/m_axi_sg_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins axi_mem_intercon/S02_ACLK] [get_bd_pins axis_accelerator_adapter_0/aclk] [get_bd_pins axis_accelerator_adapter_0/m_axis_aclk] [get_bd_pins axis_accelerator_adapter_0/s_axi_aclk] [get_bd_pins axis_accelerator_adapter_0/s_axis_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/M01_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_ports ap_rst] [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_processing_system7_0_100M/ext_reset_in]
  ...
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins axi_mem_intercon/S02_ARESETN] [get_bd_pins axis_accelerator_adapter_0/m_axis_aresetn] [get_bd_pins axis_accelerator_adapter_0/s_axi_aresetn] [get_bd_pins axis_accelerator_adapter_0/s_axis_aresetn] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M01_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axis_accelerator_adapter_0/S_AXI/Reg] SEG_axis_accelerator_adapter_0_Reg

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   guistr: "# # String gsaved with Nlview 6.5.12  2016-01-29 bk=1.3547 VDI=39 GEI=35 GUI=JA:1.6
#  -string -flagsOSRD
preplace port ap_fifo_iarg_0_empty_n -pg 1 -y 410 -defaultsOSRD
preplace port DDR -pg 1 -y 40 -defaultsOSRD
preplace port ap_fifo_oarg_0_full_n -pg 1 -y 490 -defaultsOSRD
preplace port ap_clk -pg 1 -y 200 -defaultsOSRD
preplace port ap_rst -pg 1 -y 250 -defaultsOSRD
preplace port ap_fifo_iarg_0_read -pg 1 -y 450 -defaultsOSRD
preplace port ap_fifo_oarg_0_write -pg 1 -y 530 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 60 -defaultsOSRD
preplace portBus ap_fifo_iarg_0_dout -pg 1 -y 430 -defaultsOSRD
preplace portBus ap_fifo_oarg_0_din -pg 1 -y 510 -defaultsOSRD
preplace inst axi_dma_0 -pg 1 -lvl 4 -y 450 -defaultsOSRD
preplace inst rst_processing_system7_0_100M -pg 1 -lvl 1 -y 530 -defaultsOSRD
preplace inst axis_accelerator_adapter_0 -pg 1 -lvl 3 -y 510 -defaultsOSRD
preplace inst axi_mem_intercon -pg 1 -lvl 5 -y 460 -defaultsOSRD
...
preplace netloc ap_fifo_iarg_0_read_1 1 0 3 NJ 430 NJ 430 NJ
preplace netloc axis_accelerator_adapter_0_ap_fifo_iarg_0_dout 1 2 5 720 740 NJ 740 NJ 740 NJ 430 NJ
preplace netloc axis_accelerator_adapter_0_M_AXIS_0 1 3 1 1020
preplace netloc processing_system7_0_axi_periph_M00_AXI 1 2 2 NJ 130 1020
preplace netloc processing_system7_0_M_AXI_GP0 1 1 6 340 280 NJ 280 NJ 280 NJ 280 NJ 280 2150
preplace netloc axis_accelerator_adapter_0_ap_fifo_oarg_0_full_n 1 2 5 700 240 NJ 240 NJ 240 NJ 300 NJ
preplace netloc ap_fifo_oarg_0_din_1 1 0 3 NJ 390 NJ 390 NJ
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 7 -20 290 NJ 290 NJ 270 NJ 270 NJ 270 NJ 290 2160
preplace netloc axi_dma_0_M_AXI_SG 1 4 1 1400
preplace netloc axi_mem_intercon_M00_AXI 1 5 1 1700
preplace netloc axis_accelerator_adapter_0_ap_fifo_iarg_0_empty_n 1 2 5 710 750 NJ 750 NJ 750 NJ 410 NJ
preplace netloc rst_processing_system7_0_100M_peripheral_aresetn 1 1 4 330 570 690 730 1040 610 1400
preplace netloc axi_dma_0_M_AXI_MM2S 1 4 1 1370
preplace netloc processing_system7_0_FIXED_IO 1 6 1 NJ
preplace netloc axi_dma_0_M_AXI_S2MM 1 4 1 1400
preplace netloc rst_processing_system7_0_100M_interconnect_aresetn 1 1 4 320 550 NJ 760 NJ 760 1390
preplace netloc processing_system7_0_FCLK_CLK0 1 0 7 -10 440 310 440 660 720 1030 600 1380 260 1730 270 2170
preplace netloc axi_dma_0_M_AXIS_MM2S 1 2 3 720 300 NJ 300 1360
preplace netloc processing_system7_0_axi_periph_M01_AXI 1 2 1 670
preplace netloc ap_fifo_oarg_0_write_1 1 0 3 NJ 410 NJ 410 NJ
levelinfo -pg 1 -70 150 500 870 1200 1550 1940 2190 -top 0 -bot 770
",
}
